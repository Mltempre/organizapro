  ...
  return (
    <div style={{ fontFamily: "Inter,sans-serif", background: "#030712", color: "#fff", overflowX: "hidden", maxWidth: "100vw" }}>
      ...
      <section id="planos" style={{ padding: isMobile ? "60px 16px" : "80px 40px", maxWidth: 1200, margin: "0 auto", scrollMarginTop: "80px" }}>
        ...
        <p style={{ textAlign: "center", fontSize: 13, color: "rgba(255,255,255,0.3)", marginTop: 16 }}>Implantação assistida • Configuração rápida • Suporte especializado</p>
      </section>
<p
  style={{
    textAlign: "center",
...
>
  Implantação assistida a partir de R$300
</p>
      {/* FAQ */}
