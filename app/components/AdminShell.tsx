...
const nav = [
  ...
  { l: "Pacientes",     h: "/pacientes",     i: "👤" },
  { l: "Agendamentos",  h: "/agendamentos",  i: "📅" },
  { l: "WhatsApp",      h: "/automacao",     i: "💬" },
  { l: "Chatbot IA",    h: "/chatbot",       i: "🤖" },
  { l: "Avaliacoes",    h: "/reputacao",     i: "⭐" },
  { l: "Conteudo IA",   h: "/conteudo",      i: "🤖" },
  { l: "Metricas",      h: "/metricas",      i: "📊" },
  { l: "Raio-X",        h: "/raio-x",        i: "🔬" },
  { l: "Meu Site",      h: "/site",          i: "🌐" },
...
export default function AdminShell({
  ...
  return (
    ...
    >
      {/*
        CSS handles ALL responsive layout — no JS isMobile flag needed.
        This eliminates the hydration flash: the media query fires before any JS.
      */}
      <style>{`
        /* ── Desktop default ── */
        .ash-sidebar {
        ...
        @media (max-width: 767px) {
          /* Sidebar: STARTS HIDDEN, slides in when .open */
          .ash-sidebar {
      ...
      <aside className={`ash-sidebar${sidebarOpen ? " open" : ""}`}>
        ...
        <div style={{ padding: "24px 20px 20px", borderBottom: "1px solid #1e2130", display: "flex", alignItems: "center", justifyContent: "space-between" }}>
          <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
            <div style={{ width: 34, height: 34, borderRadius: 9, background: "linear-gradient(135deg,#7c3aed,#6d28d9)", display: "flex", alignItems: "center", justifyContent: "center", fontSize: 16, flexShrink: 0 }}>
              +
            </div>
            <div>
              <div style={{ fontSize: 14, fontWeight: 700, color: "#f1f5f9" }}>ClinicaFlow</div>
              <div style={{ fontSize: 11, color: "#7c3aed" }}>Painel Clinico</div>
            </div>
          </div>
        ...
        >
          <div style={{ display: "flex", alignItems: "center", gap: 12, minWidth: 0, flex: 1 }}>
            ...
            <button
              ...
              style={{
                display: "none", /* CSS .ash-hamburger overrides to flex on mobile */
                background: "none",
