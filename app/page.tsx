...
export default function Page() {
  ...
  const wpp = () => window.open("https://wa.me/5541988379119?text=" + encodeURIComponent("Olá, quero solicitar uma demonstração da ClínicaFlow."), "_blank");
  ...
  return (
    <div style={{ fontFamily: "Inter,sans-serif", background: "#030712", color: "#fff", overflowX: "hidden", maxWidth: "100vw" }}>
      ...
      {demoModal && (
        <div className="modal-overlay" onClick={() => setDemoModal(false)}>
          <div onClick={e => e.stopPropagation()} style={{ background:"#0f172a", border:"1px solid rgba(255,255,255,0.1)", borderRadius:20, padding:isMobile ? 24 : 32, maxWidth:480, width:"100%", textAlign:"center" }}>
            ...
            <p style={{ fontSize:14, color:"rgba(255,255,255,0.6)", margin:"0 0 24px", lineHeight:1.6 }}>Fale com nossa equipe e veja o ClínicaFlow funcionando na prática com dados reais da sua especialidade.</p>
      ...
      <div className={`mobile-menu ${menuOpen ? "open" : ""}`}>
        ...
        <Link href="/blog" onClick={() => setMenuOpen(false)} style={{ fontSize:22, color:"rgba(255,255,255,0.85)", textDecoration:"none", fontWeight:600 }}>Blog</Link>
        ...
        <div style={{ width:"100%", maxWidth:1200, display:"grid", gridTemplateColumns:isMobile ? "1fr" : "1fr 440px", gap:isMobile ? 32 : 48, alignItems:"center", position:"relative", zIndex:10 }}>
          <div>
            <div style={{ display:"inline-flex", alignItems:"center", gap:8, background:"rgba(0,200,150,0.07)", border:"1px solid rgba(0,200,150,0.2)", borderRadius:999, padding:"5px 14px", marginBottom:22, fontSize:13, color:"rgba(255,255,255,0.8)" }}>
              ...
              <span>312 clínicas ativas agora</span>
            </div>

            <h1 style={{ fontSize:"clamp(28px,4.4vw,46px)", fontWeight:800, lineHeight:1.12, margin:"0 0 18px" }}>
              Sua clínica com presença digital profissional, conectada ao WhatsApp e pronta para crescer.
            </h1>

            <p style={{ fontSize:isMobile ? 15 : 17, color:"rgba(255,255,255,0.65)", margin:"0 0 28px", lineHeight:1.65 }}>
              Em poucos minutos sua clínica ganha um site profissional, automações no WhatsApp, avaliações Google e gestão completa — sem depender de agência, designer ou programador.
            </p>
            ...
            <div style={{ width:"100%", maxWidth:440, borderRadius:18, background:"#0d1526", border:"1px solid rgba(255,255,255,0.08)", boxShadow:"0 32px 64px rgba(0,0,0,0.5)", overflow:"hidden" }}>
              ...
              <div style={{ display:"grid", gridTemplateColumns:"52px 1fr" }}>
                <div style={{ background:"#080f1e", borderRight:"1px solid rgba(255,255,255,0.05)", padding:"14px 0", display:"flex", flexDirection:"column", alignItems:"center", gap:18 }}>
                  {["🏠","👥","📅","💬","⭐","📊"].map((icon,i) => (
                    <div key={i} style={{ width:32, height:32, borderRadius:9, background:i===0?"rgba(0,200,150,0.15)":"transparent", border:i===0?"1px solid rgba(0,200,150,0.3)":"none", display:"flex", alignItems:"center", justifyContent:"center", fontSize:14 }}>{icon}</div>
                  ))}
                </div>
                <div style={{ padding:"14px" }}>
                  <div style={{ display:"flex", alignItems:"center", justifyContent:"space-between", marginBottom:12 }}>
                    <div>
                      <div style={{ fontSize:12, fontWeight:700, color:"#fff" }}>Bom dia, Dra. Ana 👋</div>
                      <div style={{ fontSize:10, color:"rgba(255,255,255,0.4)" }}>Segunda-feira, 03 Jun</div>
                    </div>
                    <div style={{ width:28, height:28, borderRadius:"50%", background:"linear-gradient(135deg,#00c896,#00a878)", display:"flex", alignItems:"center", justifyContent:"center", fontSize:12, fontWeight:700, flexShrink:0 }}>A</div>
                  </div>
                  ...
                  <div style={{ background:"rgba(255,255,255,0.03)", borderRadius:10, padding:"10px 12px", border:"1px solid rgba(255,255,255,0.05)" }}>
                    ...
                    {[
                      { time:"09:00", name:"Dr. Carlos M.",   status:"green",  label:"Confirmado"   },
                      { time:"10:30", name:"Patrícia Lima",   status:"green",  label:"Confirmado"   },
                      { time:"13:00", name:"Lucas Ferreira",  status:"yellow", label:"Pendente"     },
      ...
      <section style={{ padding:isMobile ? "70px 16px" : "90px 40px" }}>
        <div style={{ maxWidth:1200, margin:"0 auto" }}>
          <div style={{ textAlign:"center", marginBottom:isMobile ? 40 : 56 }}>
            <div style={{ display:"inline-flex", alignItems:"center", gap:8, background:"rgba(0,200,150,0.07)", border:"1px solid rgba(0,200,150,0.2)", borderRadius:999, padding:"5px 16px", marginBottom:20, fontSize:12, color:"#00c896", fontWeight:700, letterSpacing:"0.08em", textTransform:"uppercase" }}>
              A plataforma completa para clínicas
            </div>
            <h2 style={{ fontSize:"clamp(26px,3.6vw,44px)", fontWeight:800, margin:"0 0 16px", lineHeight:1.12 }}>
              Sua clínica{" "}
              <span style={{ background:"linear-gradient(90deg,#00c896,#34d399)", WebkitBackgroundClip:"text", WebkitTextFillColor:"transparent" }}>organizada</span>,{" "}
              <span style={{ background:"linear-gradient(90deg,#60a5fa,#818cf8)", WebkitBackgroundClip:"text", WebkitTextFillColor:"transparent" }}>automatizada</span>{" "}
              e pronta para{" "}
            ...
            {[
              {
                ...
                color:"#00c896",
                gradient:"linear-gradient(135deg,rgba(0,200,150,0.09),rgba(0,200,150,0.02))",
                border:"rgba(0,200,150,0.22)",
                items:["Agenda inteligente","Cadastro de pacientes","Gestão de consultas","Histórico completo","Métricas em tempo real","Dashboard unificado"],
              },
              {
                ...
                items:["WhatsApp integrado","Lembretes automáticos","Confirmações de consulta","Avaliações Google","Chatbot IA 24h","Fluxos de automação"],
              },
              {
                icon:"🚀", label:"CRESÇA", title:"Mais visibilidade, mais pacientes",
                color:"#c084fc",
                gradient:"linear-gradient(135deg,rgba(192,132,252,0.09),rgba(192,132,252,0.02))",
                border:"rgba(192,132,252,0.22)",
                items:["Site profissional incluso","Conteúdo IA para redes","SEO integrado","Landing pages da clínica","Presença digital completa","Marketing automatizado"],
              },
            ].map(pillar => (
          ...
          <div style={{ textAlign:"center" }}>
            <button onClick={wpp} className="btn-primary" style={{ fontSize:isMobile ? 15 : 17, padding:isMobile ? "14px 28px" : "16px 44px" }}>
              Quero ver o ClínicaFlow funcionando
            </button>
      ...
      <section style={{ padding:isMobile ? "60px 16px" : "80px 40px", maxWidth:1200, margin:"0 auto" }}>
        <div style={{ textAlign:"center", marginBottom:48 }}>
          <h2 style={{ fontSize:"clamp(24px,3.6vw,40px)", fontWeight:800, margin:"0 0 12px" }}>O que dizem nossas clínicas</h2>
        ...
        <div style={{ display:"grid", gridTemplateColumns:isMobile ? "1fr" : "repeat(auto-fit,minmax(300px,1fr))", gap:20 }}>
          {[
            { name:"Dra. Ana Paula Ferreira", role:"Odontologista", city:"Curitiba, PR",       avatar:"A", text:"Em 3 semanas reduzi minhas faltas de 22% para 6%. O WhatsApp automático faz um trabalho que eu levaria horas para fazer manualmente. Simplesmente não consigo imaginar a clínica sem.", stars:5, metric:"−74% de faltas" },
            { name:"Dr. Carlos Mendonça",     role:"Clínico Geral", city:"São Paulo, SP",      avatar:"C", text:"Minha nota no Google saiu de 3.8 para 4.9 em dois meses. O sistema pede avaliação automaticamente depois de cada consulta. Hoje recebo mais de 40 avaliações por mês sem fazer nada.", stars:5, metric:"+51 avaliações/mês" },
            { name:"Dra. Mariana Lopes",      role:"Dermatologista", city:"Florianópolis, SC", avatar:"M", text:"O que mais me surpreendeu foi a facilidade de configuração. Em 15 minutos já estava funcionando. O suporte é ágil e o painel me dá tudo que preciso para gerenciar a clínica.", stars:5, metric:"Setup em 15 min" },
          ].map(t => (
      ...
      <section style={{ padding:isMobile ? "60px 16px" : "80px 40px", background:"rgba(255,255,255,0.015)" }}>
        <div style={{ maxWidth:860, margin:"0 auto" }}>
          <div style={{ textAlign:"center", marginBottom:40 }}>
            <h2 style={{ fontSize:"clamp(24px,3.6vw,40px)", fontWeight:800, margin:"0 0 12px" }}>Quanto sua clínica perde por mês?</h2>
      ...
      <section id="beneficios" style={{ padding:isMobile ? "60px 16px" : "80px 40px", maxWidth:1200, margin:"0 auto", scrollMarginTop:"80px" }}>
        <div style={{ textAlign:"center", marginBottom:48 }}>
          <h2 style={{ fontSize:"clamp(24px,3.6vw,40px)", fontWeight:800, margin:"0 0 12px" }}>Tudo que sua clínica precisa</h2>
      ...
      <section id="dashboard-demo" style={{ padding:isMobile ? "40px 16px 60px" : "40px 40px 60px", maxWidth:1200, margin:"0 auto", scrollMarginTop:"80px" }}>
        <div style={{ textAlign:"center", marginBottom:32 }}>
          <h2 style={{ fontSize:"clamp(24px,3.6vw,40px)", fontWeight:800, margin:"0 0 12px" }}>Um painel que parece seu produto</h2>
            ...
            <div style={{ display:"grid", gridTemplateColumns:"60px 1fr" }}>
              ...
              <div style={{ padding:24 }}>
                <div style={{ display:"flex", alignItems:"center", justifyContent:"space-between", marginBottom:22 }}>
                  <div>
                    <div style={{ fontSize:16, fontWeight:800 }}>Bom dia, Dra. Ana Paula 👋</div>
                    <div style={{ fontSize:12, color:"rgba(255,255,255,0.4)" }}>Segunda-feira, 03 de Junho de 2026</div>
                  </div>
                  <div style={{ display:"flex", alignItems:"center", gap:10 }}>
                    <div style={{ fontSize:12, color:"rgba(255,255,255,0.4)", background:"rgba(255,255,255,0.04)", border:"1px solid rgba(255,255,255,0.07)", borderRadius:8, padding:"6px 12px" }}>Clínica Bem Estar</div>
                    <div style={{ width:34, height:34, borderRadius:"50%", background:"linear-gradient(135deg,#00c896,#00a878)", display:"flex", alignItems:"center", justifyContent:"center", fontSize:13, fontWeight:800, flexShrink:0 }}>AP</div>
                  </div>
                </div>
                ...
                <div style={{ display:"grid", gridTemplateColumns:"1.3fr 0.7fr", gap:16 }}>
                  <div style={{ background:"rgba(255,255,255,0.03)", border:"1px solid rgba(255,255,255,0.06)", borderRadius:14, padding:18 }}>
                    <div style={{ display:"flex", alignItems:"center", justifyContent:"space-between", marginBottom:14 }}>
                      ...
                      <div style={{ fontSize:11, color:"#00c896", background:"rgba(0,200,150,0.08)", border:"1px solid rgba(0,200,150,0.15)", borderRadius:6, padding:"2px 8px" }}>18 consultas</div>
                    </div>
                    {[
                      { time:"09:00", name:"Dr. Carlos Mendonça", type:"Retorno",     status:"green"  },
                      ...
                      { time:"16:00", name:"João Almeida",        type:"Limpeza",     status:"green"  },
                    ].map(apt => (
      ...
      <section id="como-funciona" style={{ padding:isMobile ? "60px 16px" : "80px 40px", background:"rgba(255,255,255,0.015)", scrollMarginTop:"80px" }}>
        <div style={{ maxWidth:1200, margin:"0 auto", textAlign:"center" }}>
          ...
          <div style={{ display:"grid", gridTemplateColumns:isMobile ? "1fr" : "repeat(auto-fit,minmax(250px,1fr))", gap:isMobile ? 36 : 32 }}>
            {[
              { n:"01", title:"Agende sua demonstração", desc:"Veja o ClínicaFlow funcionando na prática com dados reais da sua clínica. Nossa equipe cuida de toda a implantação assistida." },
      ...
      <section id="planos" style={{ padding:isMobile ? "60px 16px" : "80px 40px", maxWidth:1200, margin:"0 auto", scrollMarginTop:"80px" }}>
        ...
        <div style={{ display:"grid", gridTemplateColumns:isMobile ? "1fr" : "repeat(auto-fit,minmax(280px,1fr))", gap:22, alignItems:"start" }}>
          {[
            { name:"Start",   price:"R$297", period:"/mês", color:"#64748b", features:["Cadastro de pacientes","Agendamentos","Lembretes automáticos"],                                         cta:"Solicitar Demonstração", msg:"Olá, quero solicitar uma demonstração do Plano Start da ClínicaFlow." },
            { name:"Pro",     price:"R$497", period:"/mês", color:"#00c896", popular:true, features:["Tudo do Start","Avaliações Google","WhatsApp automatizado","Relatórios completos"],       cta:"Solicitar Demonstração", msg:"Olá, quero solicitar uma demonstração do Plano Pro da ClínicaFlow." },
            { name:"Premium", price:"R$697", period:"/mês", color:"#94a3b8", features:["Tudo do Pro","🏆 Site Profissional Incluso","Landing page da clínica","Suporte prioritário"],            cta:"Falar com Vendas",       msg:"Olá, quero conhecer o Plano Premium da ClínicaFlow." },
          ].map(p => (
      ...
      <section id="faq" style={{ padding:isMobile ? "60px 16px" : "80px 40px", background:"rgba(255,255,255,0.015)", scrollMarginTop:"80px" }}>
        <div style={{ maxWidth:760, margin:"0 auto" }}>
          ...
          {[
            { q:"Preciso de conhecimento técnico?",             a:"Não! O ClínicaFlow foi feito para ser usado por qualquer pessoa. Setup em 5 minutos sem precisar de programador." },
            { q:"Como funciona o WhatsApp automático?",         a:"Você conecta seu WhatsApp Business ao sistema. O ClínicaFlow envia lembretes, confirmações e mensagens automaticamente para seus pacientes." },
            { q:"Posso cancelar quando quiser?",                a:"Sim. Sem fidelidade e sem multa. Você pode cancelar quando quiser." },
            { q:"O sistema funciona para qualquer especialidade?", a:"O foco atual é odontologia, mas funciona para qualquer clínica de saúde: medicina, estética, psicologia e mais." },
            { q:"Como funciona a demonstração personalizada?",  a:"Trabalhamos com demonstração personalizada e implantação assistida para mostrar exatamente como o ClínicaFlow funciona na rotina da sua clínica." },
          ].map((faq,i) => (
      ...
      <section style={{ padding:isMobile ? "70px 16px" : "100px 40px", textAlign:"center", position:"relative", overflow:"hidden" }}>
        ...
        <div style={{ position:"relative", maxWidth:600, margin:"0 auto" }}>
          <h2 style={{ fontSize:"clamp(26px,3.6vw,42px)", fontWeight:800, margin:"0 0 14px" }}>
            ...
            <span style={{ background:"linear-gradient(135deg,#00c896,#00a878)", WebkitBackgroundClip:"text", WebkitTextFillColor:"transparent" }}>sua clínica?</span>
          </h2>
