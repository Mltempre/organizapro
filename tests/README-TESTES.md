...
npx tsc --module commonjs --target es2020 --esModuleInterop --skipLibCheck --strict false \
  ...
  lib/cobranca-state-machine.ts lib/motor-cobranca.ts lib/pedido-state-machine.ts
